...
export async function generateMetadata(props: AddressPageMetadataProps): Promise<Metadata> {
    return withSentryTraceData({
        description: `Contents of the security.txt for the program with address ${props.params.address} on Nara`,
        title: `Security | ${await getReadableTitleFromAddress(props)} | Nara`,
    });
}
