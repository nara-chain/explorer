    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light">
            ...
            <div className="container">
                ...
                <div
                    className="navbar-children d-none d-xl-flex align-items-center flex-grow-1 h-100"
                    style={{ minWidth: 0 }}
                >
                    {children}
                </div>
            ...
            <div className="navbar-right-nara d-none d-lg-flex align-items-center" style={{ gap: '12px' }}>
                ...
                <a href="https://discord.gg/aeNMBjkWsh" target="_blank" rel="noopener noreferrer" className="nav-social-icon" aria-label="Discord">
